<template>
  <div v-if="modelValue" class="fixed inset-0 z-50 flex items-center justify-center px-6">
    ...
    >
      <div
        v-if="icon"
        class="w-10 h-10 rounded-xl flex items-center justify-center mx-auto mb-3"
        :class="iconBg"
      >
        <svg
          class="w-5 h-5"
      ...
      <h3
        :id="titleId"
        class="text-base font-semibold text-theme-text mb-1.5"
      ...
      <div
        :id="messageId"
        class="text-sm text-theme-text-muted mb-4"
        :class="icon ? 'text-center' : ''"
      >
        <slot name="message">
          <p>{{ message }}</p>
      ...
      <label
        ...
        :class="
          checkboxChecked
            ? 'border-theme-accent bg-theme-accent-bg/30'
        ...
        <div
          ...
          :class="
            checkboxChecked
              ...
              : 'border-theme-border-md bg-theme-card'
          "
        >
          <svg
      ...
      <div class="space-y-2">
        <button
          ...
          :class="[
            confirmClass,
            requireCheckbox && !checkboxChecked ? 'opacity-40 cursor-not-allowed' : '',
          ]"
