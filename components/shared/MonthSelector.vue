<template>
  ...
  >
    ...
    <div class="text-center">
      ...
      <p
        v-if="esActual && showCurrentLabel"
        class="text-[0.6875rem] text-theme-accent/70 font-medium mt-0.5"
      >
        Mes actual
      </p>
      <p
        v-else-if="!esActual && showCurrentLabel"
        class="text-[0.6875rem] text-theme-accent/60 font-medium mt-0.5"
      >
    ...
    <button
      ...
      :class="
        disableNext
          ? 'bg-theme-card text-theme-text-muted opacity-40 cursor-not-allowed'
          : 'bg-theme-card text-theme-text-muted active:bg-theme-border-md active:scale-95'
      "
