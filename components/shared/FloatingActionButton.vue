<template>
  ...
  >
    <slot>
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 drop-shadow-sm" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
...
const toneClass = computed(() => ({
  accent: 'bg-theme-accent text-theme-on-accent opacity-70 hover:opacity-85 shadow-theme-accent/25',
