<template>
  <div class="px-4 lg:px-0 pb-2">
    ...
    <Transition name="slide-up">
      <div v-if="mesSeleccionado" class="mt-3 bg-theme-card rounded-2xl border border-theme-border overflow-hidden">
        ...
        <div v-if="cargando" class="px-4 py-6 text-center">
          <svg class="mx-auto h-5 w-5 animate-spin text-theme-accent" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
const {
  serie6Meses, mesActual, anioActual, ahorrosList,
