<template>
  <SharedBaseBottomSheet title="Metas de ahorro" @close="$emit('close')">
    ...
    <button
      class="w-full py-3.5 rounded-xl bg-theme-accent text-theme-text font-semibold text-sm transition-colors hover:bg-theme-accent-dark mt-4 flex items-center justify-center gap-2"
      :disabled="saving"
      @click="guardar"
    >
