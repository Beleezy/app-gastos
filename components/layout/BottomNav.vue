<template>
  <nav
    class="fixed bottom-0 left-0 right-0 z-40 nav-glass lg:hidden"
      ...
      >
        ...
        <div class="relative">
          <div
            ...
            :class="
              isActive(item.to) ? 'bg-theme-accent-bg scale-105' : 'group-hover:bg-theme-border-md'
            "
          >
            <component
              :is="item.icon"
