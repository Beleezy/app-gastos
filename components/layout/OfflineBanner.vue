<template>
  <Transition name="banner">
    <!-- En flujo (no fixed) para no tapar los headers sticky de las páginas. -->
    <div
      v-if="!isOnline"
      class="relative z-30 flex items-center justify-center gap-2 bg-red-500/95 text-white text-xs font-medium py-2 px-4"
    >
      ...
      Sin conexión — los datos podrían no estar actualizados
    </div>
  </Transition>
</template>
...
.banner-leave-active { transition: opacity 0.25s ease-in; }
