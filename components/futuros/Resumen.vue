    ...
    <div class="relative overflow-hidden rounded-2xl border border-theme-border bg-gradient-to-br from-theme-card to-theme-card/90 p-4 space-y-4">
      ...
      <template v-if="resumenFuturos.totalProyectos > 0">
        ...
        <div class="relative text-center">
          ...
          <p class="mt-1 text-3xl font-bold text-sky-300 truncate">
        ...
        <div class="grid grid-cols-3 gap-2">
          <div class="rounded-xl border border-theme-border bg-theme-input p-2.5 text-center min-w-0">
            <p class="text-[9px] uppercase tracking-[0.18em] text-theme-text-muted">Detalles</p>
            <p class="mt-1 text-lg font-bold text-theme-text">{{ resumenFuturos.totalDetalles }}</p>
          </div>
          <div class="rounded-xl border border-theme-border bg-theme-input p-2.5 text-center min-w-0">
            <p class="text-[9px] uppercase tracking-[0.18em] text-theme-text-muted">Opciones</p>
            <p class="mt-1 text-lg font-bold text-theme-text">{{ resumenFuturos.totalOpciones }}</p>
          </div>
          <div class="rounded-xl border border-theme-border bg-theme-input p-2.5 text-center min-w-0">
            <p class="text-[9px] uppercase tracking-[0.18em] text-theme-text-muted">Decididos</p>
            <p class="mt-1 text-lg font-bold text-theme-text">
