  ...
  <Transition name="voz-overlay">
    <div v-if="showVozOverlay" class="fixed inset-0 z-50 flex flex-col items-center justify-center">
      <div
        ...
        @click="cerrarVozOverlaySiInactivo"
      ></div>
          ...
          <div class="bg-theme-card rounded-xl px-4 py-3 border border-amber-500/30">
            ...
            <div v-if="isEditing">
              ...
              <div class="flex items-center gap-2 mt-2">
                <button
                  class="flex-1 py-1.5 rounded-lg bg-purple-500/15 text-purple-400 text-xs font-medium hover:bg-purple-500/25"
                  @click="saveEdit"
                >
                  Guardar
                </button>
                <button
                  class="flex-1 py-1.5 rounded-lg bg-theme-border-md text-theme-text-muted text-xs font-medium hover:bg-theme-border-md"
                  @click="cancelEdit"
                >
                  Cancelar
                </button>
            ...
            <div
              v-if="!isEditing"
              class="grid grid-cols-4 gap-1.5 mt-3 pt-3 border-t border-theme-border"
            >
              <button
                class="flex flex-col items-center gap-1 py-2 rounded-lg bg-emerald-500/15 text-emerald-400 text-[0.6875rem] leading-tight font-medium hover:bg-emerald-500/25"
                @click="enviarDraft"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                class="flex flex-col items-center gap-1 py-2 rounded-lg bg-amber-500/15 text-amber-400 text-[0.6875rem] leading-tight font-medium hover:bg-amber-500/25"
                @click="startEdit"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                class="flex flex-col items-center gap-1 py-2 rounded-lg bg-purple-500/15 text-purple-400 text-[0.6875rem] leading-tight font-medium hover:bg-purple-500/25"
                @click="regrabar"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <button
                class="flex flex-col items-center gap-1 py-2 rounded-lg bg-red-500/10 text-red-400 text-[0.6875rem] leading-tight font-medium hover:bg-red-500/20"
                @click="descartarDraft"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="w-4 h-4"
