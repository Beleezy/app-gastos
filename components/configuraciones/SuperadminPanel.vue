  ...
  >
    <div class="flex items-center justify-between gap-2">
      <div class="flex items-center gap-2 min-w-0">
        <div
          class="w-10 h-10 rounded-xl bg-theme-accent/15 flex items-center justify-center text-theme-accent shrink-0"
        >
          <svg
        ...
        <div class="min-w-0">
          ...
          <p class="text-sm text-theme-text-sec leading-relaxed">
            Aprueba o limita quién puede usar el sistema.
          </p>
        </div>
      </div>
      <div class="flex items-center gap-2 shrink-0">
        <span
          ...
          class="px-2 py-0.5 rounded-full bg-amber-500/20 text-amber-400 text-[0.6875rem] font-semibold"
        >
