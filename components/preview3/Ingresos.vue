<template>
  <div class="px-4 pt-3 pb-32">
    <Preview3PageHeader icon="💵" title="Ingresos" subtitle="Tu flujo neto del mes" accent="green" />
    ...
    <template v-else>
      ...
      <div class="rounded-3xl border border-theme-border bg-gradient-to-br from-emerald-500/5 to-theme-card p-4 mb-3">
        ...
        <Preview3Money :value="resumen.saldoNeto" signo tone="auto" class="text-[1.7rem] font-extrabold block mt-1" />
        ...
        <div class="grid grid-cols-2 gap-2.5 mt-3">
          <div class="rounded-xl bg-theme-input p-3 min-w-0">
            ...
            <Preview3Money :value="resumen.totalIngresos" entero tone="green" class="text-base font-bold block mt-0.5" />
          </div>
          <div class="rounded-xl bg-theme-input p-3 min-w-0">
            <p class="text-[0.62rem] uppercase tracking-wide text-theme-text-muted">Gastos</p>
            <Preview3Money :value="resumen.totalGastos" entero tone="red" class="text-base font-bold block mt-0.5" />
          </div>
        </div>
      </div>
          ...
          <div class="flex items-start gap-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <div class="flex items-center justify-between gap-2 mt-1">
                ...
                <Preview3Money :value="ing.monto" signo tone="green" class="text-base font-bold shrink-0" />
              </div>
            </div>
          </div>
        </article>
