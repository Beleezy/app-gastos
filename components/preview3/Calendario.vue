<template>
  <div class="px-4 pt-3 pb-32">
    <Preview3PageHeader icon="📅" title="Calendario" subtitle="Cobros, pagos y vencimientos" />
          ...
          <div class="flex items-start gap-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <div class="flex items-center justify-between gap-2 mt-1">
                ...
                <Preview3Money :value="ev.monto" :tone="ev.signo > 0 ? 'green' : 'red'" :signo="ev.signo > 0" class="text-sm font-bold shrink-0" />
              </div>
            </div>
          </div>
        </article>
