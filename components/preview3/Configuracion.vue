<template>
  <div class="px-4 pt-3 pb-32">
    <Preview3PageHeader icon="⚙️" title="Configuración" subtitle="Perfil y preferencias" />
    ...
    <template v-else>
      ...
      <div class="rounded-2xl border border-theme-border bg-theme-card divide-y divide-theme-border/60 mb-4">
        ...
        <div class="flex items-center justify-between gap-3 px-4 py-3.5 min-h-[52px]">
          ...
          <Preview3Money :value="config.presupuestoMensualDefault" entero class="text-sm font-semibold text-theme-text shrink-0" />
        </div>
        <div class="flex items-center justify-between gap-3 px-4 py-3.5 min-h-[52px]">
