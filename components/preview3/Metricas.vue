<template>
  <div class="px-4 pt-3 pb-32">
    <Preview3PageHeader icon="📊" title="Métricas" subtitle="Tu historia financiera, mes a mes" />
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-2 gap-2.5 mb-3">
        <div class="rounded-2xl border border-theme-border bg-theme-card p-4 min-w-0">
          ...
          <Preview3Money :value="promedios.gastosMensual" compact entero tone="red" class="text-lg font-extrabold block mt-1.5" />
        ...
        <div class="rounded-2xl border border-theme-border bg-theme-card p-4 min-w-0">
          ...
          <Preview3Money :value="promedios.ingresosMensual" compact entero tone="green" class="text-lg font-extrabold block mt-1.5" />
          <p class="text-[0.64rem] text-theme-text-muted mt-1">por mes</p>
        </div>
      </div>
      ...
      <div class="space-y-2">
        <div v-for="(m, i) in serieReciente" :key="i" class="rounded-2xl border border-theme-border bg-theme-card p-4">
          <div class="flex items-center justify-between gap-2 mb-2.5">
            ...
            <Preview3Money :value="m.saldoNeto" signo tone="auto" class="text-sm font-bold shrink-0" />
          </div>
          <div class="grid grid-cols-3 gap-1.5">
            <div class="min-w-0">
              <p class="text-[0.6rem] uppercase tracking-wide text-theme-text-muted">Ingresos</p>
              <Preview3Money :value="m.ingresos" compact entero tone="green" class="text-[0.82rem] font-semibold block mt-0.5" />
            </div>
            <div class="min-w-0">
              <p class="text-[0.6rem] uppercase tracking-wide text-theme-text-muted">Gastos</p>
              <Preview3Money :value="m.gastos" compact entero tone="red" class="text-[0.82rem] font-semibold block mt-0.5" />
            </div>
            <div class="min-w-0">
              <p class="text-[0.6rem] uppercase tracking-wide text-theme-text-muted">Ahorro</p>
              <Preview3Money :value="m.ahorros" compact entero tone="sky" class="text-[0.82rem] font-semibold block mt-0.5" />
            </div>
          </div>
        </div>
      </div>
