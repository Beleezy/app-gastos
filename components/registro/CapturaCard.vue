<template>
  <div class="rounded-2xl border border-theme-border bg-theme-card px-4 pt-3 pb-4">
    ...
    <!-- Trio de botones alineados centralmente -->
    <div class="flex items-center justify-center gap-5 sm:gap-7">
      <!-- Foto -->
      <button
        class="w-11 h-11 rounded-2xl flex items-center justify-center bg-theme-input border border-theme-border text-amber-400 hover:bg-theme-card-hover active:scale-90 transition-all shadow-sm shadow-black/10"
      ...
      <!-- Manual -->
      <button
        class="w-11 h-11 rounded-2xl flex items-center justify-center bg-theme-input border border-theme-border text-theme-accent hover:bg-theme-card-hover active:scale-90 transition-all shadow-sm shadow-black/10"
    ...
    <!-- Draft de voz (vista previa intacta) -->
    <div class="mt-3 px-1">
      <RegistroDraftVoz
        :transcript="transcript"
        :has-draft="hasDraft"
