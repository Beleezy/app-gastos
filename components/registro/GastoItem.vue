      ...
      <div v-if="selectable" class="flex items-center pl-3 pr-0 shrink-0">
        ...
        >
          <svg
            v-if="selected"
            xmlns="http://www.w3.org/2000/svg"
            class="w-3 h-3 text-theme-on-accent"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            stroke-width="3"
      ...
      <div class="flex items-stretch flex-1 min-w-0">
        ...
        <div class="flex-1 min-w-0 py-2.5 pr-2.5">
          ...
          <div class="flex items-start justify-between gap-2">
            ...
            <p
              class="shrink-0 text-sm font-bold text-theme-text leading-tight whitespace-nowrap"
          ...
          <p
            v-if="gasto.notas"
            class="mt-1 text-[0.6875rem] text-theme-text-muted break-words leading-snug"
          >
            {{ gasto.notas }}
          </p>
          ...
          <div class="flex items-center gap-1.5 mt-1">
            <div class="flex items-center gap-1.5 min-w-0 flex-1 flex-wrap">
              <span
                ...
                :style="{
                  backgroundColor: (gasto.categoriaColor || '#6b7280') + '18',
                  color: gasto.categoriaColor || '#6b7280',
                }"
