...
export default defineEventHandler(async (event) => {
  ...
  // típico desde la cola offline), se devuelve la respuesta original sin
  // insertar gastos duplicados. La reserva es una fila con índice único,
  // así que también protege entre instancias.
  return conIdempotencia(event, usuarioId, async () => {
