<template>
  <div class="min-h-screen pb-4">
    ...
    <div class="px-5 pt-8 pb-3 relative overflow-hidden">
      ...
      <div class="relative flex items-center gap-3 mb-1">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="text-[0.6875rem] text-theme-text-sec mt-0.5">Lleva las finanzas de tus familiares</p>
        </div>
      </div>
    </div>
    ...
    <!-- Explicación -->
    <div class="px-5 mb-4">
      <div class="rounded-2xl border border-dashed border-theme-border bg-theme-card/40 p-3 text-[0.6875rem] text-theme-text-muted leading-relaxed">
    ...
    <div v-if="mostrarForm" class="px-5 mb-4">
      <div class="bg-theme-card border border-theme-border rounded-2xl p-4 space-y-3">
        ...
        <div>
          <label class="block text-[0.6875rem] text-theme-text-muted mb-1">Relación <span class="text-theme-text-muted">(opcional)</span></label>
        ...
        <div>
          <label class="block text-[0.6875rem] text-theme-text-muted mb-1">WhatsApp <span class="text-theme-text-muted">(opcional)</span></label>
          ...
          <p class="text-[0.6875rem] text-theme-text-muted mt-1">Con código de país, sin espacios ni símbolos. Se usa para enviarle reportes.</p>
        </div>
        <div>
          <label class="block text-[0.6875rem] text-theme-text-muted mb-1">Presupuesto mensual <span class="text-theme-text-muted">(opcional)</span></label>
        ...
        <div>
          <label class="block text-[0.6875rem] text-theme-text-muted mb-1">Correo de contacto <span class="text-theme-text-muted">(opcional)</span></label>
        ...
        <div>
          <label class="block text-[0.6875rem] text-theme-text-muted mb-1">Fecha de nacimiento <span class="text-theme-text-muted">(opcional)</span></label>
        ...
        <div>
          <label class="block text-[0.6875rem] text-theme-text-muted mb-1">Notas <span class="text-theme-text-muted">(opcional)</span></label>
    ...
    <div class="px-5 space-y-2">
      ...
      <div v-else-if="!perfiles.length && !mostrarForm" class="text-center py-10">
        ...
        <p class="text-[0.6875rem] text-theme-text-muted mt-1">Crea uno para empezar a administrar sus finanzas</p>
      </div>
      ...
      >
        <div class="flex items-center justify-between gap-2">
          <div class="flex items-center gap-2.5 min-w-0">
            ...
            <div class="min-w-0">
              <p class="text-sm text-theme-text font-semibold truncate">{{ p.nombre }}<span v-if="p.relacion" class="text-[0.6875rem] font-normal text-theme-text-muted"> · {{ p.relacion }}</span></p>
