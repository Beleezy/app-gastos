<template>
  <div>
    ...
    <div
      class="max-w-lg mx-auto lg:max-w-none lg:mx-0 px-4 lg:px-0 py-4 lg:py-6 space-y-4 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-6"
    >
      <!-- Loading -->
      ...
      <template v-else>
        ...
        <details class="lg:col-span-2 group" open>
          <summary
            class="cfg-summary flex items-center justify-between gap-3 cursor-pointer select-none bg-theme-card border border-theme-border rounded-2xl px-4 py-3 min-h-[3rem]"
          >
            <span class="text-sm font-semibold text-theme-text flex-1">
              ...
              <span class="block text-[0.6875rem] font-normal text-theme-text-sec mt-0.5"
                >Nombre, presupuesto, moneda, zona horaria</span
              >
            </span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="cfg-chev w-4 h-4 text-theme-text-muted transition-transform shrink-0"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              stroke-width="2"
          ...
          <div class="mt-3 space-y-4 lg:grid lg:grid-cols-2 lg:gap-6 lg:space-y-0">
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              ...
              <p class="text-xs text-theme-text-sec mb-3">
                Tu nombre aparecerá en los reportes PDF generados.
              </p>
              <input
                id="cfg-nombre"
                v-model="form.nombre"
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              <div class="flex items-center gap-2 mb-1">
                ...
                <label for="cfg-presupuesto" class="text-sm font-medium text-theme-text"
                  >Presupuesto mensual por defecto</label
                >
              </div>
              <p class="text-xs text-theme-text-sec mb-3">
                Este monto se usará como presupuesto base al crear un nuevo mes en el planificador.
              </p>
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              ...
              <p class="text-xs text-theme-text-sec mb-3">
                Moneda principal para mostrar tus montos.
              </p>
              <select
                id="cfg-moneda"
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              <div class="flex items-center gap-2 mb-1">
                ...
                <label for="cfg-zona" class="text-sm font-medium text-theme-text"
                  >Zona horaria</label
                >
              </div>
              <p class="text-xs text-theme-text-sec mb-3">
                Afecta el cálculo de fechas en el registro por voz.
              </p>
              <select
                id="cfg-zona"
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              <div class="flex items-center gap-2 mb-1">
                ...
                <label for="cfg-locale" class="text-sm font-medium text-theme-text"
                  >Formato regional</label
                >
              </div>
              <p class="text-xs text-theme-text-sec mb-3">
                Formato de números y reconocimiento de voz.
              </p>
              <select
                id="cfg-locale"
                v-model="form.locale"
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              <div class="flex items-center gap-2 mb-1">
                ...
                <label for="cfg-dia-ciclo" class="text-sm font-medium text-theme-text"
                  >Dia de inicio del ciclo</label
                >
              </div>
              <p class="text-xs text-theme-text-sec mb-3">
                El dia del mes en que comienza tu ciclo financiero.
              </p>
              <input
                id="cfg-dia-ciclo"
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              <div class="flex items-center gap-2 mb-1">
                ...
                <label for="cfg-dias-pdf" class="text-sm font-medium text-theme-text"
                  >Dias de saldadas en PDF</label
                >
              </div>
              <p class="text-xs text-theme-text-sec mb-3">
                Cantidad de dias hacia atras para incluir deudas saldadas al exportar PDF.
              </p>
              <input
                id="cfg-dias-pdf"
        ...
        <details class="lg:col-span-2 group">
          ...
          >
            <span class="text-sm font-semibold text-theme-text flex-1">
              ...
              <span class="block text-[0.6875rem] font-normal text-theme-text-sec mt-0.5"
                >Tema, tamaño de letra, accesibilidad</span
              >
            </span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="mt-3 space-y-4 lg:grid lg:grid-cols-2 lg:gap-6 lg:space-y-0">
                ...
                >
                  ...
                  >
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      class="w-5 h-5"
                      :class="c.id === 'blanco' ? 'text-theme-text-muted' : 'text-theme-text'"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      stroke-width="2.5"
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              ...
              <p class="text-xs text-theme-text-sec mb-3">
                Ajusta el tamano del texto en toda la aplicacion. Ideal para mejorar la legibilidad.
              </p>
                ...
                <button
                  ...
                  :class="
                    fontSize === size.id
                      ...
                      : 'border-theme-border hover:border-theme-border-md'
                  "
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              <label class="flex items-center justify-between cursor-pointer">
                <div class="flex items-center gap-2.5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="w-5 h-5 text-theme-text-sec shrink-0"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
                  ...
                  <div>
                    ...
                    <p class="text-[0.6875rem] text-theme-text-sec leading-tight">
                      Reduce la variedad de colores y mejora el contraste
                    </p>
                  </div>
                </div>
                <button
        ...
        <details class="lg:col-span-2 group">
          ...
          >
            <span class="text-sm font-semibold text-theme-text flex-1">
              ...
              <span class="block text-[0.6875rem] font-normal text-theme-text-sec mt-0.5"
                >Vistas del historial y tus categorías</span
              >
            </span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="mt-3 space-y-4 lg:grid lg:grid-cols-2 lg:gap-6 lg:space-y-0">
            ...
            <div class="bg-theme-card rounded-2xl p-5 border border-theme-border">
              ...
              <p class="text-xs text-theme-text-sec mb-3">
                Elige que vistas mostrar en el historial de gastos. Puedes activar ambas a la vez.
              </p>
              <div class="space-y-3">
                <label class="flex items-center justify-between cursor-pointer">
                  <div class="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p class="text-[0.6875rem] text-theme-text-sec leading-tight">
                        Gastos agrupados por dia individual
                      </p>
                    </div>
                  </div>
                  <button
            ...
            >
              <div class="flex items-center gap-3">
                ...
                <div class="text-left">
                  <label
                    class="text-sm font-medium text-theme-text block group-hover:text-theme-accent transition-colors cursor-pointer"
                    >Mis categorias</label
                  >
                  <span class="text-xs text-theme-text-sec"
                    >Administra, crea o personaliza tus categorias</span
                  >
                </div>
              </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="w-5 h-5 text-theme-text-muted group-hover:text-theme-accent transition-colors"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                stroke-width="2"
        ...
        <button
          ...
          :class="
            hasChanges
              ...
              : 'bg-theme-border-md text-theme-text-sec cursor-not-allowed'
          "
      ...
      <div class="text-center pt-4 pb-8">
        <p class="text-xs text-theme-text-muted">
          Mis Finanzas v{{ useRuntimeConfig().public.appVersion }}
        </p>
...
details[open] > .cfg-summary .cfg-chev {
  transform: rotate(180deg);
}
details[open] > .cfg-summary {
